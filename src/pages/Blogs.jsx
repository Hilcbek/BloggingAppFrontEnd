...
const Blogs = () => {
  ...
  return (
    <div className={`${loading ? 'flex items-center justify-center flex-col' : 'flex items-start justify-start flex-col' } my-5 relative`}>
          <div className='my-2 flex items-center justify-start mr-1 w-full'>
